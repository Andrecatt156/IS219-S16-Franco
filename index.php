            ...
            <div class="home-content text-center">
                <div class="container">
                    <div class="main-flex-slider">
                        <ul class="slides">
                            <li>
                                <h1>Andres<span class="colored-text">Franco</span> </h1>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center wow animated fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms">
                        <p class="lead margin-btm-30">
                           Andres Franco strives to bring you the best web design, development, or consulting you will find in Flanders, New Jersey. Just remember I'm here to help you grow your business and look big until you are big!
                        </p>
                    </div>
                </div>
                <div class="row services">
                    <div class="col-md-4 margin-btm-30">
                        <div class="service-box wow animated fadeInUp"  data-wow-duration="700ms" data-wow-delay="300ms">
                            ...
                            <p>We combine old and new techniques to produce designs that stand out.</p>
                        </div>
                    </div><!--service col end-->
                    <div class="col-md-4 margin-btm-30">
                        <div class="service-box wow animated fadeInUp"  data-wow-duration="700ms" data-wow-delay="400ms">
                            ...
                            <p>Simplicity, creativity, and strategy are the most important parts of any website.</p>
                        </div>
                    </div><!--service col end-->
                    <div class="col-md-4 margin-btm-30">
                        <div class="service-box wow animated fadeInUp"  data-wow-duration="700ms" data-wow-delay="500ms">
                            ...
                            <p>We efficiently scale your websites with a single code base, from phones to tablets to desktops with CSS media queries.</p>
                        </div>
                    </div><!--service col end-->
                ...
                <div class="row">
                    <div class="col-sm-3 text-center">
                        <div class="progress-circle">
                            ...
                            <div class="chart" data-percent="90" data-scale-color="#25CBF5">
                                <span>90%</span>
                    ...
                    <div class="col-sm-3 text-center">
                        <div class="progress-circle">
                            ...
                            <div class="chart" data-percent="60" data-scale-color="#25CBF5">
                                <span>60%</span>
                                <canvas height="120" width="120"></canvas>
                            </div>
                            <p class="progress-text">SQL</p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 text-center">
                        <div class="progress-circle">
                            ...
                            <div class="chart" data-percent="80" data-scale-color="#25CBF5">
                                <span>80%</span>
                                <canvas height="120" width="120"></canvas>
                            </div>
                    ...
                    <div class="col-sm-12 text-center">
                        <div class="progress-circle">
                            <div class="chart" data-percent="55" data-scale-color="#25CBF5">
                                <span>50%</span>
                                <canvas height="120" width="120"></canvas>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="team-col wow animated fadeInLeft"  data-wow-duration="700ms" data-wow-delay="100ms">
                            ...
                            <p>B.S in Information Technology, expected December 2016</br>
                            Specialization: Web applications</p>
                        </div>
                    </div><!--team col-->
        ...
        <section class="parallax testimonials bg-heading" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="center-heading text-center">
                            <h2 class="wow animated bounceIn"  data-wow-duration="700ms" data-wow-delay="100ms">Relevant Course Work</h2>
                    ...
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <div id="testi-carousel" class="owl-carousel">
                                ...
                                <div class="coursework">
                                    <h4>
                                        <ul>
                                           ...
                                           <li> Information Design Techniques</li>            
                                        </ul>
                                    </h4>
                                </div>
                                ...
                                <div class="coursework">
                                    <h4>
                                        <ul>
                                            <li>Database Design, Management and Applications</li>
        ...
        <section id="work" class="section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="center-heading text-center">
                            <h2 class=" wow animated bounceIn"  data-wow-duration="700ms" data-wow-delay="100ms">Work Experience</h2>
